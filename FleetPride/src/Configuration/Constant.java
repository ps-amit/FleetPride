...
public class Constant {
	...
	public static String chromedriverlocations = Sourceloc + "\\driver\\chromedriver.exe";
	public static String firefoxdriverlocation = Sourceloc + "\\driver\\geckodriver.exe";
	
	//----------------------------------------
	
	public static String operadriverlocation = Sourceloc + "\\driver\\operadriver.exe";
	...
	static String configFileLoc=	System.getProperty("user.dir") + "\\src\\DataEngine\\config.properties";
	...
	public static boolean ExcelReport = false;
	...
	public static String EmailBody1 = "after zipping." + "\r\n"
			...
			+ "Fleet Pride Automation Team" + "\r\n\r\n\r\n\r\n\r\n\r\n"
			+ "Note: This is an automated e-mail of Automation Test result reports. Hence, please do not reply to this e-mail. The alert has been sent to the registered e-mail ID. In case you wish to register an alternate e-mail ID, please Contact Fleet Pride Autoamation team: vikrant.chutani@timesgroup.com";
	...
	public static String EmailSubject = "Puresoftware Automation Report";
	public static final String emailUsername = "amit.singh@puresoftware.com";
	public static final String emailPassword = "Amit@Clpps2107g";
			//"mickeybunny";

	// Please use ";" as a separator for more then one recipient.
	public static String tolist = "amit.singh@puresoftware";
