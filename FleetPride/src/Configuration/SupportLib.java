...
public class SupportLib {
	...
	public static void browserconfig(String Browser) {
		...
		System.setProperty("webdriver.chrome.driver", Constant.chromedriverlocations);
	}
	...
	public static void waitForAjax() throws Exception {
	...
	static void waitForPageLoad(WebDriver driver) throws InterruptedException{
	...
	public static void AdsHelpControl() throws InterruptedException {
		...
		WebElement eleOverlay= ActionKeyword.driver.findElement(By.xpath("//div[@class='deskLayout cc_deskLayout']//*[@id='overlay']"));
		//WebElement CCno=ActionKeyword.driver.findElement(By.xpath("//*[@id=\"ccnumfield\"]"));
		System.out.println("overlay  "+eleOverlay);
		Thread.sleep(2000);
		...
		/*for (int i = 0; i < 20; i++) {
			...
			try {
				Thread.sleep(1000);
				WebElement spinner = ActionKeyword.driver.findElement(By
						.xpath("//div[@id='blockpage' and @class='ng-hide']"));
...
/*
		...
		try {
			WebDriverWait wait = new WebDriverWait(ActionKeyword.driver, Constant.ExplicitWait);
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(".//div[@id='blockpage' and @class='ng-hide']")));
		}
		 catch (Exception e) {
	...
	public static List<String> GetParticularText(List<WebElement> webElementCollection,int index) {
		...
		for (WebElement we : webElementCollection) {
			...
			String fromelement=we.getText();
			String[] strArr = fromelement.split("\\r?\\n");
				TextFromPageList.add(strArr[index]);
