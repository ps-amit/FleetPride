...
//import com.sfqty.salesforce_connection;

import Configuration.ActionKeyword;
import Configuration.Constant;
import Configuration.SendReport;
...
public class TestCaseRunner {
	...
	public static void main(String[] args) throws Exception {
		...
		//emailBody.append("<b>QA Engg.</b> : Amit K Singh<br/>");
		emailBody.append("<b>Project </b> : PDC ECOM <br/>");
		emailBody.append("<br/>");
		
		emailBody.append("<table border='1' style='border-collapse:collapse;text-align:center'>");
		emailBody.append("<tr>");
		//emailBody.append(" <th style='padding:5px'>S.No</th>");
		...
		if (totaltestcaserun >= 1) {
			...
			System.out.println("we are here   "+totaltestcaserun);
			SendReport.sendmail();
		}
	...
	private void testsuitrun() throws Exception {
		testSuitResult = true;
		testScriptResult = true;
		int DataCount;
		Constant.ObjrepLoc.clear();
	...
	ActionKeywords.listValues.clear();
	ActionKeywords.listAttributes.clear();
	ActionKeywords.nullCount.clear();
	ActionKeywords.ValuesCaptured.clear();
	ActionKeywords.ExcelValuesCaptured.clear();
	ActionKeywords.rateCaptured.clear();
	ActionKeywords.compsetRate.clear();
